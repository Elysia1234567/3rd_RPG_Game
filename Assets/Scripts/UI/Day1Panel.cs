...
public class Day1Panel : BasePanel
{
    int FllowChange;
    ...
    public override void ShowMe()
    {
        ...
        FllowChange = 0;
        DiaryLocalizeStringEvent.StringReference.SetReference("DiaryTable", 1);
        StartCoroutine(SetTextUI(LocalizationSettings.StringDatabase.GetTable("DiaryTable").GetEntry("1").GetLocalizedString()));
    ...
    protected override void ClickBtn(string btnName)
    {
        switch (btnName)
        {
            ...
            case "returnBtn":
                ...
                UIMgr.Instance.HidePanel<Day1Panel>(true);

                break;
            case "confirmBtn1":
                if(GetControl<Image>("Select11p").gameObject.activeInHierarchy|| GetControl<Image>("Select12p").gameObject.activeInHierarchy)
                {
                ...
                break;
            case "confirmBtn2":
                if(GetControl<Image>("Select21p").gameObject.activeInHierarchy|| GetControl<Image>("Select22p").gameObject.activeInHierarchy)
                {
